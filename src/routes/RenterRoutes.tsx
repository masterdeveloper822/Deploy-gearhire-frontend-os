...
export default [
  ...
  <Route path="/browse-training-course" element={<BrowseTrainingCourse />} />,
  <Route path="/rfq-list" element={<RfqList />} />,
  <Route path="/edit-rfq" element={<EditRfq />} />,
  <Route path="/renter-notification" element={<Notification />} />,
  <Route path="/renter-message" element={<RenterMessage />} />,
  <Route path="/add-review" element={<AddNewReview />} />,
  <Route path="/renter-edit-profile" element={<EditRenterProfile />} />,
