...
const typographyVariants = {
  ...
  heroSub:
    "text-[16px] md:text-[20px] font-normal leading-6 md:leading-7 text-gray-600 relative text-left",
  ...
  reviewText:
    "block text-base font-normal leading-tight text-gray-600 text-left",
};
