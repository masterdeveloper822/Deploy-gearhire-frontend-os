...
import reviewIcon from "@/assets/images/ui/icons/review.svg";
import half_reviewIcon from "@/assets/images/ui/icons/half_review.svg";
import woman1Img from "@/assets/images/avatars/woman1.png";
import man1Img from "@/assets/images/avatars/man1.png";
import man2Img from "@/assets/images/avatars/man2.png";

const UsersSay: React.FC = () => {
  return (
    <div className="bg-gray-50 w-full p-6 md:py-24 md:px-6 flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8 justify-center items-center lg:items-stretch">
          {/* Card 1 */}
          <Card className="flex-1 rounded-xl shadow-md flex flex-col p-6 min-w-64 max-w-[400px]">
          ...
          <Card className="flex-1 rounded-xl shadow-md flex flex-col p-6 min-w-64 max-w-[400px]">
            <CardHeader className="flex flex-row items-center mb-4 p-0">
              ...
              />
              <div className="ml-4">
                <Typography variant="reviewUserName">Sarah Johnson</Typography>
                <Typography variant="reviewUserInfo">
            ...
            <CardContent className="flex flex-col flex-1 p-0">
              <div className="mb-4">
                ...
                <Typography variant="reviewText">needs."</Typography>
              </div>
              <div className="flex items-center gap-1 mt-auto">
                <img src={reviewIcon} alt="Review" className="w-5 h-4" />
                <img src={reviewIcon} alt="Review" className="w-5 h-4" />
          ...
          <Card className="flex-1 rounded-xl shadow-md flex flex-col p-6 min-w-64 max-w-[400px]">
            <CardHeader className="flex flex-row items-center mb-4 p-0">
              ...
              />
              <div className="ml-4">
                <Typography variant="reviewUserName">David Chen</Typography>
                <Typography variant="reviewUserInfo">
