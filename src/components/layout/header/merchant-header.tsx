  ...
  return (
    <HeaderFrame>
      <div className="flex items-center gap-1 sm:gap-2 md:gap-4 px-2 sm:px-0">
        ...
        <span className="hidden md:inline text-gray-700 text-sm sm:text-base font-medium truncate max-w-[80px] sm:max-w-none">
          ProGear Studios
        </span>
        <Button
          variant="ghost"
          className="p-1 sm:p-2 bg-transparent hover:bg-gray-100"
        >
          <img
