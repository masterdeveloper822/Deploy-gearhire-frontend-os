    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-[1280px] mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          ...
          <Button
            variant="skyPrimary"
            className="h-12 px-8 flex items-center gap-2 hover:bg-sky-700"
          >
        ...
        <div className="flex flex-col gap-6">
          ...
          {[
            ...
            <Card
              key={item.title}
              className="rounded-lg shadow flex flex-col md:flex-row items-start md:items-center gap-6 p-6"
            >
        ...
        <div className="flex justify-center items-center gap-2 mt-8">
          ...
          <button className="w-8 h-8 flex items-center justify-center rounded bg-sky-600 text-white font-semibold">
            1
          </button>
          <button className="w-8 h-8 flex items-center justify-center rounded text-gray-700 hover:bg-gray-100">
            2
          </button>
          <button className="w-8 h-8 flex items-center justify-center rounded text-gray-700 hover:bg-gray-100">
            3
