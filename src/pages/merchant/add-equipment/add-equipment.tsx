...
import uploadIcon from "@/assets/images/ui/icons/camera.svg";
      ...
      <main className="max-w-[1280px] mx-auto px-20 py-8">
        ...
        <form className="w-full max-w-2xl bg-white rounded-lg shadow p-8 flex flex-col gap-8 mt-8">
              ...
              {photos.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-4">
                  {photos.map((file, idx) => (
                    <div
                      key={idx}
                      className="w-20 h-20 rounded overflow-hidden bg-gray-200 flex items-center justify-center"
                    >
                      <img
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <Button
              type="submit"
              className="flex-1 bg-sky-600 hover:bg-sky-700 text-white text-base font-medium h-12 rounded-lg"
            >
              Save Equipment
            </Button>
            <Button
