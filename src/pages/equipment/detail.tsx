    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-8 lg:flex-row">
        ...
        <section className="flex-1">
          {/* Back Button */}
          <button className="mb-6 flex items-center gap-2 text-gray-600">
            <img src={imgFrame3} alt="Back" className="h-5 w-5" /> Back to
            Equipment
          </button>
          {/* Main Image */}
          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            />
            <span className="font-medium text-gray-700">CineGear Pro</span>
          ...
          <div className="mb-6 rounded-lg bg-white p-6 shadow">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-gray-700">
                <img src={imgFrame10} alt="Spec" className="h-5 w-5" /> Canon EF
                Mount (PL Mount available)
              </li>
            </ul>
          </div>
          {/* Additional Images */}
          <div className="mb-6 rounded-lg bg-white p-6 shadow">
            ...
            <div className="flex gap-4">
              <img
                src={imgImg1}
                alt="Main"
                className="h-44 w-44 rounded-lg border-2 border-sky-500 object-cover"
              />
              <img
                src={imgImg3}
                alt="Alt1"
        ...
        {/* Right Sidebar */}
        <aside className="flex w-full flex-shrink-0 flex-col gap-8 lg:w-96">
          {/* About the Merchant */}
          <div className="rounded-lg bg-white p-6 shadow">
            ...
            <button className="mb-2 w-full rounded-lg bg-sky-600 px-6 py-3 font-medium text-white">
              View Profile
            </button>
            <button className="w-full rounded-lg border border-gray-300 px-6 py-3 font-medium text-gray-700">
              View Inventory
            </button>
          </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow">
            ...
            <button className="mb-2 flex w-full items-center justify-center gap-2 rounded-lg bg-green-600 px-6 py-3 font-medium text-white">
              <img src={imgFrame11} alt="RFQ" className="h-5 w-5" /> Create RFQ
              for this Item
            </button>
            <button className="mb-2 flex w-full items-center justify-center gap-2 rounded-lg border border-sky-600 px-6 py-3 font-medium text-sky-600">
              <img src={imgFrame12} alt="Message" className="h-5 w-5" /> Message
              Merchant
            </button>
