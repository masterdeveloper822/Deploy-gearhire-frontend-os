...
export default function Body() {
  const [selectedType, setSelectedType] = useState<"renter" | "merchant" | null>(null);
              ...
              {["renter", "merchant"].map((type) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-medium text-base text-gray-900 mb-1">{label}</span>
